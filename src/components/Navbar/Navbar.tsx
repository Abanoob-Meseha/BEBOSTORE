...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 w-[95%] bg-white p-4 mx-auto rounded-xl shadow-2xl flex items-center justify-between">
      ...
      <div className={`${isOpen?"flex":"hidden"} flex-col absolute top-[70px] w-[90%] left-[5%] items-center bg-blue-100 rounded-md p-4 gap-4 text-center md:flex md:flex-row md:bg-transparent md:static md:p-0 md:justify-between md:w-[60%]`}>
